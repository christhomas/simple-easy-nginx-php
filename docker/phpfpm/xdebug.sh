...
if [[ "${XDEBUG_ENABLE}" == "1" ]]; then
    # Here we replace values in the xdebug template file with the values from the environment variables
    # These variables are found inside the env/xdebug file in this project
    ...
    # If xdebug is disabled, remove the configuration file and log file
